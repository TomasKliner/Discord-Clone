...
export default function Sidebar(){
    return(
        <div className="h-screen w-16 p-2 bg-neutral-800 flex flex-col">
            ...
            rounded-full w-contain absolute -bottom-[4px] -right-[4px] p-[0.2rem] text-[0.5rem] font-bold px-2">10</span>
            </div>
            
            <hr className="border-neutral-600"></hr>
            <span></span>

            <img className="shadow rounded-full my-4 hover:rounded-2xl" src="https://upload.wikimedia.org/wikipedia/commons/4/45/Notion_app_logo.png" alt="logo"></img>
