...
export default function Rooms(){
    ...
    <div className="flex flex-col justify-start">
        ...
        <div className="my-2">
        <div className="flex items-center hover:bg-neutral-400 px-2 rounded mt-1 mx-4 cursor-pointer py-1"><div className="mr-2 font-light">🔊</div>Talk1</div>
        <div className="flex items-center hover:bg-neutral-400 px-2 rounded mt-1 mx-4 cursor-pointer py-1"><div className="mr-2 font-light">🔊</div>Talk2</div>
        <div className="flex items-center hover:bg-neutral-400 px-2 rounded mt-1 mx-4 cursor-pointer py-1"><div className="mr-2 font-light">🔊</div>Talk3</div>
         </div>
